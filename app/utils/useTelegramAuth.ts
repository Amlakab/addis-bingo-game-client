...
export const useTelegramAuth = () => {
  ...
  const clearOldSession = () => {
    ...
    try {
      ...
      console.error(
        '❌ [Auth] Failed to clear browser session:',
        error
      );
    }
  };
        ...
        if (code) {
          ...
          try {
            ...
            if (
              ...
              if (!token || !userData) {
                throw new Error(
                  'Backend returned success but token or user data is missing.'
                );
              }
              ...
              try {
                ...
                console.error(
                  '❌ [Telegram Auth] Failed to save session:',
                  storageError
                );
              }
            ...
            if (isMounted) {
              ...
              setPopup({
                ...
                type: 'error',
                message:
                  `Telegram Login Failed: ${errorMessage}`
              });
            }
            ...
            if (isMounted) {
              ...
              setPopup({
                ...
                type: 'error',
                message:
                  `Authentication Error: ${serverError}`
              });
            }
